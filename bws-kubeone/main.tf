...
module "bws-base" {
  source = "git::https://github.com/valiton-k8s-blueprints/terraform.git//bws/base?ref=v1.1.2"
...
module "bws-bootstrap" {
  source = "git::https://github.com/valiton-k8s-blueprints/terraform.git//bws/bootstrap?ref=v1.1.2"
