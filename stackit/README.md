...
## Usage
Based on STACKITs: How to use STACKIT DNS for DNS01 to act as a DNS01 ACME Issuer with Cert-Manager
...
module "gitops-ske-addons" {
  ...
  cert_manager_default_cert_domain_list      = ["poc.my-project.runs.onstackit.cloud", "*.poc.my-project.runs.onstackit.cloud"]
